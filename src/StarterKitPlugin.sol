                ...
                if(unprefixedResource.length == 0) {
                    ...
                    body = string.concat("<html>"
                            ...
                            "<body>"
                                ...
                                "<p>This plugin is a template to help you make your OCWebsite plugin</p>"
                                "<h3>Main resources</h3>"
                                "<ul>"
                                    "<li><a href='https://github.com/nand2/ocweb-plugin-starter-kit'>Starter Kit Plugin repository</a> : Fork it and build it</li>"
                                    "<li><a href='https://github.com/nand2/ocweb#develop-your-own-ocwebsite-plugin'>Plugin documentation on the OCWeb repository</a></li>"
                                "</ul>"
                                ...
                                "<p>There are 2 ways to store user config for the plugin:</p>"
                                "<ol>"
                                    "<li>Config stored in the plugin smart contract. Best for config elements that are required by the smart contract itself. <br /> Config example: Root path: <code>", rootPath, "</code></li>"
                                    "<li>Config stored in a file stored via the staticFrontend plugin. Best for all the other settings, as it is more flexible.<br /> Config example: this plugin use the <code>.config/starter-kit/config.json</code> file, whose content is currently: <code id='json-config'></code></li>"
                                "</ol>"
                                "<script>"
                                ...
                                "<script>"
                                    ...
                                    "fetchBlocknumber();"
                                "</script>"
                                "<p>Pagination: Go to <a href='page/1'>Page 1</a></p>"
                            "</body>"
                        "</html>");
                    statusCode = 200;
